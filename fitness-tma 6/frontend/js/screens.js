...
// ============================================================
const SCREEN_IDS = [
  "loading", "onboarding", "home", "profile", "settings",
  "exercises", "workout-log", "history", "plans", "premium", "habits", "shop",
];
...
const Screens = {
  ...
  show(name) {
    ...
    if (name === "shop") Shop.load();
    if (name === "home") { Home.render(); Challenges.load(); Leaderboard.load(); }

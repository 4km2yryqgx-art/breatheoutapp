...
class PurchasedWorkoutTemplate(Base):
    """Купленная за Stars готовая тренировка из магазина (шаблоны — статичные, id из shop_data.py)"""
    __tablename__ = "purchased_workout_templates"

...
async def exercise_personal_record(
    ...
    is_cardio = exercise is not None and exercise.muscle_group == "cardio"
    ...
    if not entries:
        return {"has_history": False, "is_cardio": is_cardio}

    if is_cardio:
        best_speed, best_duration, total_sets = 0, 0, 0
        ...
        return {
            "has_history": True, "is_cardio": True,
            "best_speed": best_speed, "best_duration": best_duration,
            "total_sets": total_sets, "total_sessions": len(entries),
        }
    ...
    return {
        "has_history": True, "is_cardio": False,
